...
public class FlatMapExample  {  
    public static void main(String args[])  {  
        List<String> productlist1 = Arrays.asList("Printer", "Mouse", "Keyboard", "Motherboard");  List<String>  
        productlist2 = Arrays.asList("Scanner", "Projector", "Light Pen"); 
        ...
        //One way: for each loop iterates over the list  
        ...
        //Another way: creats a stream of elements using flatMap()  
        ...
        allproducts.stream().flatMap(innerList -> innerList.stream()).collect(Collectors.toList());
    }  
}
